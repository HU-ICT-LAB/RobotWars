    ...
    with open(file_name, "r") as file:
        ...
        for point in data:
            ...
            if data[point]["rotation"][1] == 90 or data[point]["rotation"][1] == 270:
                ...
                pygame.draw.line(surface=screen, color=[0, 0, 0], start_pos=(x1+border, y1+border), end_pos=(x2+border, y2+border), width=3)
...
if __name__ == "__main__":
    ...
    screen = pygame.display.set_mode((800, 600))
    screen.fill([255, 255, 255])
    pygame.draw.circle(screen, [0, 0, 0], [200, 200], 2, 2)
    screen = create_map("test_corner.yaml")
    pygame.display.update()
    x = True
    while x:
        time.sleep(10)
