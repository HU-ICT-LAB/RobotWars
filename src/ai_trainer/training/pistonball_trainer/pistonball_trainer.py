"""Test how multi-agent reinforcement learning works on the pistonball trainer."""
import os
...
env = pistonball_v5.parallel_env(n_pistons=20, time_penalty=-0.1, continuous=True, random_drop=True, random_rotate=True,
